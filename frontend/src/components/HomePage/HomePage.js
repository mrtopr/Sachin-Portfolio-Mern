...
// import ProfilePhoto from `${process.env.PUBLIC_URL}/Sachin.webp`;
...
function HomePage({
  ...
  const keywords = [
    ...
    "Problem Solver | 150+ LeetCode | IIIT Bhubaneswar",
    "Building responsive web apps with JavaScript",
  ];
        ...
        >
          <div className="home-div">
            <div className="home-row" style={{ zIndex: 100000 }}>
              ...
              >
                <animated.img
                  src={`${process.env.PUBLIC_URL}/Sachin.webp`}
                  alt="Profile"
