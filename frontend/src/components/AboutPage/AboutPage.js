...
// import AboutImg from "../../../public/Sachin-Profile-Photo.webp";
import Resume from "../../assets/Sachin_Kumar_Resume2026.pdf";

const aboutData = [
  {
    icon: "bx bx-code-alt about-icon",
    title: "CS Undergrad",
    subtitle: "B.Tech CE, IIIT Bhubaneswar",
  },
  {
  ...
  {
    icon: "bx bxs-palette about-icon",
    title: "Web Developer",
    subtitle: "Frontend Focused",
  },
];
        ...
        <div className="about-content glass">
          ...
          <div className="about-container">
            <motion.div className="about-row">
              <motion.img
                src={`${process.env.PUBLIC_URL}/Sachin-Profile-Photo.webp`}
            ...
            <motion.div className="about-row">
              <motion.div
                ...
                exit="hidden"
              >
                <span className="about-name">Sachin Kumar</span>
                <p className="about-role">
                  Computer Engineering Student | Web Developer | Problem Solver
                </p>
                <p className="about-description">
                  Hey, I'm Sachin — a 2nd year Computer Engineering student at
                  IIIT Bhubaneswar with a strong foundation in problem-solving
                  and core CS concepts. I build responsive web applications
                  using JavaScript, HTML, CSS, and modern frameworks. With 150+
                  LeetCode problems solved and hands-on project experience, I'm
                  actively improving my algorithmic thinking and expanding into
